...
def replace_all(target,search,replace):
	return replace.join(target.split(search))
...
replace = "yTHH"
find = "fhWhTB"
target = "TFkvfhWhTBrtnfhWhTBsfhWhTBrxYRfhWhTBvMX"
print(replace_all(target, find, replace))

#"TFkvyTHHrtnyTHHsyTHHrxYRyTHHvMX". However, it returned the str "yTHHWhTBrtnfhWhTBsfhWhTBrxYRfhWhTBvMX".
